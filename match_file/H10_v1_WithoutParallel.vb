...
Module H10_v1_WithoutParallel
    ...
    Sub Main()
        ...
        EmailNotify.SendEmail("headletters10 Logic Test for (ALL) " + ST.ToString(), ST, "start")
    ...
    Sub MATCHFILE_JU()
        ...
        connection.Close()
        Process_match_Key_set_JU(ds, m_planet)
        'Parallel.Invoke(
    ...
    Sub MATCHFILE_SA()
        ...
        connection.Close()
        Process_match_Key_set_SA(ds, m_planet)
        'Parallel.Invoke(
    ...
    Sub Process_match_Key_set_MA(ByVal RowsData As DataSet, ByRef m_planet As String)
        ThreadStartCounter += 1
        Dim a8(55) As String
        For i As Integer = 0 To counter_MA
            Dim pa = m_planet
            Dim p1 = RowsData.Tables(0).Rows(i)(0).Trim.ToString()
            Dim p2 = RowsData.Tables(0).Rows(i)(1).Trim.ToString()
            Dim p3 = RowsData.Tables(0).Rows(i)(2).Trim.ToString()
    ...
    Sub Process_match_Key_set_ME(ByVal RowsData As DataSet, ByRef m_planet As String)
        ThreadStartCounter += 1
        Dim a8(55) As String
        For i As Integer = 0 To counter_ME
            Dim pa = m_planet
            Dim p1 = RowsData.Tables(0).Rows(i)(0).Trim.ToString()
            Dim p2 = RowsData.Tables(0).Rows(i)(1).Trim.ToString()
            Dim p3 = RowsData.Tables(0).Rows(i)(2).Trim.ToString()
    ...
    Sub Process_match_Key_set_MO(ByVal RowsData As DataSet, ByRef m_planet As String)
        ThreadStartCounter += 1
        Dim a8(55) As String
        For i As Integer = 0 To counter_MO
            Dim pa = m_planet
            Dim p1 = RowsData.Tables(0).Rows(i)(0).Trim.ToString()
            Dim p2 = RowsData.Tables(0).Rows(i)(1).Trim.ToString()
            Dim p3 = RowsData.Tables(0).Rows(i)(2).Trim.ToString()
    ...
    Sub Process_match_Key_set_JU(ByVal RowsData As DataSet, ByRef m_planet As String)
        ThreadStartCounter += 1
        Dim a8(55) As String
        For i As Integer = 0 To counter_JU
            Dim pa = m_planet
            Dim p1 = RowsData.Tables(0).Rows(i)(0).Trim.ToString()
            Dim p2 = RowsData.Tables(0).Rows(i)(1).Trim.ToString()
            Dim p3 = RowsData.Tables(0).Rows(i)(2).Trim.ToString()
    ...
    Sub Process_match_Key_set_SA(ByVal RowsData As DataSet, ByRef m_planet As String)
        ThreadStartCounter += 1
        Dim a8(55) As String
        For i As Integer = 0 To counter_SA
            Dim pa = m_planet
            Dim p1 = RowsData.Tables(0).Rows(i)(0).Trim.ToString()
            Dim p2 = RowsData.Tables(0).Rows(i)(1).Trim.ToString()
            Dim p3 = RowsData.Tables(0).Rows(i)(2).Trim.ToString()
    ...
    Sub Process_match_Key_set_SU(ByVal RowsData As DataSet, ByRef m_planet As String)
        ThreadStartCounter += 1
        Dim a8(55) As String
        For i As Integer = 0 To counter_SU
            Dim pa = m_planet
            Dim p1 = RowsData.Tables(0).Rows(i)(0).Trim.ToString()
            Dim p2 = RowsData.Tables(0).Rows(i)(1).Trim.ToString()
            Dim p3 = RowsData.Tables(0).Rows(i)(2).Trim.ToString()
    ...
    Sub Process_match_Key_set_VE(ByVal RowsData As DataSet, ByRef m_planet As String)
        ThreadStartCounter += 1
        Dim a8(55) As String
        For i As Integer = 0 To counter_VE
            Dim pa = m_planet
            Dim p1 = RowsData.Tables(0).Rows(i)(0).Trim.ToString()
            Dim p2 = RowsData.Tables(0).Rows(i)(1).Trim.ToString()
            Dim p3 = RowsData.Tables(0).Rows(i)(2).Trim.ToString()
