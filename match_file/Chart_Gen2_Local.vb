...
Module Chart_Gen2_Local
    ...
    Dim SelectHCUSP = "SELECT * FROM HCUSP"
    Dim SelectHPLANET = "SELECT * FROM HPLANET"

    Sub Main()
        Dim starttime As DateTime = DateTime.Now
        EmailNotify.SendEmail("ChartGen2_Local Started", starttime, "start")
        MakeCusp()
        MakeCusp_checkHouse()
        WriteToCuspTable()
        HRAKE()
        EmailNotify.SendEmail("ChartGen2_Local Ended", starttime, "end")
    End Sub
    Sub MakeCusp()
    ...
    Sub HRAKE()
        ...
        Dim M_uid As String = "XXXXXXXXXX"
        Dim M_Hid As String = "1000000001"
        Dim SelectHPLANET_RA = "SELECT * FROM HPLANET WHERE UID = '" + M_uid + "' AND HID = '" + M_Hid + "' AND PLANET = 'RA'"
        Dim SelectHPLANET_KE = "SELECT * FROM HPLANET WHERE UID = '" + M_uid + "' AND HID = '" + M_Hid + "' AND PLANET = 'KE'"
