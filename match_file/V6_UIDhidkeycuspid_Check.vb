...
Module V6_UIDhidkeycuspid_Check
    Dim c01(), c02(), c03(), c04(), c05(), c06(), c07(), c08(), c09(), c10(), c11(), c12() As String
    Dim counter = 0
    Dim ListOfUIDhidkeycuspid As New List(Of V6_UIDhidkeycuspid)()
    ...
    Sub Main()
        ...
        EmailNotify.SendEmail("KeyCheck Logic added For MA " + ST.ToString(), ST, "start")
        ...
        EmailNotify.SendEmail("KeyCheck Logic added For MA " + ST.ToString(), ST, "end")
    ...
    Sub MATCHFILE_MA()
        ...
        Dim connection As SqlConnection = New SqlConnection(connstr)
        connection.Open()
        Dim cmd As New SqlCommand("TRUNCATE TABLE MATCHFILE; SELECT * FROM F2PLANETS WHERE p0 = 'MA';", con)
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
    ...
    Sub MATCHFILE_JU()
        ...
        Dim connection As SqlConnection = New SqlConnection(connstr)
        connection.Open()
        Dim cmd As New SqlCommand("TRUNCATE TABLE MATCHFILE; SELECT * FROM F2PLANETS WHERE p0 = 'JU';", con)
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
    ...
    Sub MATCHFILE_SA()
        ...
        Dim connection As SqlConnection = New SqlConnection(connstr)
        connection.Open()
        Dim cmd As New SqlCommand("TRUNCATE TABLE MATCHFILE; SELECT * FROM F2PLANETS WHERE p0 = 'SA';", con)
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
    ...
    Sub MATCHFILE_ME()
        ...
        Dim connection As SqlConnection = New SqlConnection(connstr)
        connection.Open()
        Dim cmd As New SqlCommand("TRUNCATE TABLE MATCHFILE; SELECT * FROM F2PLANETS WHERE p0 = 'ME';", con)
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
    ...
    Sub MATCHFILE_MO()
        ...
        Dim connection As SqlConnection = New SqlConnection(connstr)
        connection.Open()
        Dim cmd As New SqlCommand("TRUNCATE TABLE MATCHFILE; SELECT * FROM F2PLANETS WHERE p0 = 'MO';", con)
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
    ...
    Sub MATCHFILE_VE()
        ...
        Dim connection As SqlConnection = New SqlConnection(connstr)
        connection.Open()
        Dim cmd As New SqlCommand("TRUNCATE TABLE MATCHFILE; SELECT * FROM F2PLANETS WHERE p0 = 'VE';", con)
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
    ...
    Sub MATCHFILE_SU()
        ...
        Dim connection As SqlConnection = New SqlConnection(connstr)
        connection.Open()
        Dim cmd As New SqlCommand("TRUNCATE TABLE MATCHFILE; SELECT * FROM F2PLANETS WHERE p0 = 'SU';", con)
        Dim da As New SqlDataAdapter(cmd)
        Dim ds As New DataSet()
    ...
    Sub Match_Key(ByRef m_planet As String, ByVal m_key As String, ByVal combo() As String, ByVal Cuspp() As String, ByVal cloc As String)
        ...
        For mega As Integer = 0 To 7
            ...
            If pattern = True Then
                ...
                Dim KeyClass As V6_UIDhidkeycuspid = New V6_UIDhidkeycuspid()
                KeyClass.uid = uid
                KeyClass.hid = hid
                KeyClass.m_key = m_key
                KeyClass.cuspId = cloc
                Dim con As New SqlConnection
                Dim cmd As New SqlCommand
                If ListOfUIDhidkeycuspid.Contains(KeyClass) = False Then
                    Try
                        con.ConnectionString = connstr
                        con.Open()
                        cmd.Connection = con
                        cmd.CommandText = "INSERT INTO MATCHFILE VALUES ('" + uid + "','" + hid + "','" + m_planet + "','" + m_key + "','" + pstr1 + "','" + cloc + "','" + pstr2 + "','" + If(mstr.Length > 16, mstr.Substring(0, 16), mstr) + "');"
                        cmd.ExecuteNonQuery()
                        ListOfUIDhidkeycuspid.Add(KeyClass)
                    Catch ex As Exception
