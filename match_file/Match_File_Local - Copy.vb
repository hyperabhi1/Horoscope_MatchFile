...
Module Match_File_Local
    ...
    Dim SelectF2PLANET = "SELECT top 10000 * FROM F2PLANETS"
    ...
    Sub MakeCusp_checkHouse()
        ...
        For Each Row As DataRow In ds0.Tables(0).Rows
            m_key = Row.Item(0).ToString() + Row.Item(1).ToString() + Row.Item(2).ToString() + Row.Item(3).ToString()
            m_key = m_key + Row.Item(4).ToString() + Row.Item(5).ToString() + Row.Item(6).ToString() + Row.Item(7).ToString()
        ...
        Next
    End Sub
    Sub Match_Key(ByVal combo() As String, ByVal Cuspp() As String, ByVal cloc As String)
        Dim fl1 As String = "N"
        Dim fl2 As String = "N"
        Dim fl3 As String = "N"
        Dim fl4 As String = "N"
        ...
        If pattern = True Then
            ...
            query = "INSERT INTO MATCH_FILE VALUES ('" + uid + "','" + hid + "','" + m_planet + "','" + m_key + "','" + pstr1 + "','" + cloc + "','" + pstr2 + "','" + m_str + "')"
